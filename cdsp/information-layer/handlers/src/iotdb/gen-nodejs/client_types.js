...
TSExecuteStatementResp.prototype.write = function(output) {
  ...
  if (this.aliasColumns !== null && this.aliasColumns !== undefined) {
    ...
    for (var iter60 in this.aliasColumns) {
      if (this.aliasColumns.hasOwnProperty(iter60)) {
        iter60 = this.aliasColumns[iter60];
        output.writeByte(iter60);
      }
    }
    output.writeListEnd();
    output.writeFieldEnd();
  ...
  if (this.queryResult !== null && this.queryResult !== undefined) {
    ...
    for (var iter61 in this.queryResult) {
      if (this.queryResult.hasOwnProperty(iter61)) {
        iter61 = this.queryResult[iter61];
